...
public class Homework {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Contains 'banana': " + contains(testList, "banana"));
        System.out.println("Has exactly one 'orange': " + hasExactly(testList, "orange"));
        System.out.println("Unique elements: " + unique(testList));
    }
    /**
